package com.microservices.example.UserMicroservicedemo.config;

import com.microservices.example.UserMicroservicedemo.config.interceptor.RestTemplateInterceptor;
